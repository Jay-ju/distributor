            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
					...
					<shiro:hasAnyPermissions name="goods:goodsTimes:view,goods:shareGoods:view,goods:goodsTimes:settingDraw,goods:winner:view">
	                    <li>
	                        <a href="#"><i class="fa fa-gift"></i><span class="nav-label">分享管理</span><span class="fa arrow"></span></a>
	                        <ul class="nav nav-second-level">
								<shiro:hasAnyPermissions name="goods:goodsTimes:view">
									<li>
										<a class="J_menuItem" href="${ctx }/goods/goodsTimes/list">模板管理</a>
									</li>
								</shiro:hasAnyPermissions>
								<shiro:hasAnyPermissions name="goods:goodsTimes:settingDraw">
									<li>
										<a class="J_menuItem" href="${ctx }/goods/goodsTimes/list-setting">分享记录</a>
									</li>
								</shiro:hasAnyPermissions>
	                        </ul>
	                    </li>
                	...
                	<shiro:hasAnyPermissions name="notice:notice:view,notice:noticeMessage:view,notice:noticeWithdraw:view,notice:noticeOnlySend:view,article:article:view">
	                    <li>
	                        ...
	                        <shiro:hasAnyPermissions name="notice:noticeMessage:view,notice:noticeWithdraw:view,notice:noticeOnlySend:view">
	                            <li><a class="J_menuItem" href="${ctx }/notice/noticeMessage/list">浏览记录</a>
	                            </li>
	                        </shiro:hasAnyPermissions>
	                        </ul>
	                    </li>
					...
					<shiro:hasAnyPermissions name="member:member:view,member:memberLevel:view">
	                    <li>
	                        ...
	                        <ul class="nav nav-second-level">
	                            ...
	                            -->
	                            <li><a class="J_menuItem" href="${ctx }/member/member/list">消费者管理</a>
	                            </li>
	                            <li><a class="J_menuItem" href="${ctx }/member/member/list">经销商管理</a>
	                            </li>
	                            <li><a class="J_menuItem" href="${ctx }/member/member/recharge">订单查询</a>
	                            </li>
	                        </ul>
	                    </li>
                    </shiro:hasAnyPermissions>
