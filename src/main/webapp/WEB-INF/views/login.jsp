...
<body class="signin">
    <div class="signinpanel">
        <div class="row">
            ...
            <div class="col-sm-5">
                <form action="${ctx}/login" method="post" id="signupForm">
                    ...
                    <div class="form-group">
                        <div>
                        	<input type="password" class="form-control pword m-b" placeholder="密码" name="password" value="" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div>
        ...
        <div class="signup-footer">
            <div class="pull-left">
                <h4>&copy; Copyright 2016 Weekend All Rights Reserved.</h4>
            </div>
        </div>
    </div>
</body>
