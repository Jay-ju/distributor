	...
	<div class="max-box">
		...
		<div class="d_tab line">
			<ul>
				...
				<li><a
					href="${ctx}/wx/order/snatch/record/personal/list?userId=${userId}&state=1"
					target="_self">进行中</a></li>
				<li class="hot">已揭晓</li>
			</ul>
		</div>
		<div class="record">
				...
				<c:forEach items="${page.result}" var="entity">
					<li class="plr clearfloat line"><a
								...
								target="_self" class="inner">
									...
									<div class="r_c">
									   <c:if test="${entity.winngUserId == userId}">
	                                        <div class="con_txt_canyu" style="display:inline;float:right">
										...
										<div class="quan lr">
											<p class="large low">
												获奖者：<a
													href="${ctx}/wx/order/snatch/record/others/list?userId=${entity.winngUserId}"
													class="blur">${entity.winngUserName}</a>
											</p>
											<p class="low can large">
												本期参与<em class="pink2">${entity.winngUserBuyTimes}</em>人次
											</p>
											<p class="large low">
												幸运号码：<b class="pink2">${entity.luckNum}</b>
											</p>
											<div class="large www low">
												揭晓时间：
												<fmt:formatDate value="${entity.openTime}"
    ...
    wxcommon.autoLoad({
        ...
        doRowDataFun: function(rowData){                // 格式化行级数据
            ...
            '<div class="r_c">'+
              ...
              '<div class="quan lr"><p class="large low">获奖者：<a href="${ctx}/wx/order/snatch/record/others/list?userId='+rowData.winngUserId+'" class="blur">'+rowData.winngUserName+'</a></p>'+
