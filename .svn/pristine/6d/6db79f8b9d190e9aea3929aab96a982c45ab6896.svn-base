...
<body>
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				<div class="ibox-content">
                    ...
                    <form:form id="iosAuditForm" modelAttribute="paramsEntity" action="${ctx}/sys/config/save" method="post" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">全局参数</label>
                            <div class="col-sm-6">
                    <form:input path="params[iosAudit]" cssClass="required span3" placeholder="请输入全局参数" /> (只能输入0和1)
                            </div>
                            <label class="col-sm-4 control-label hint" style="text-align: left;"> </label>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-2">
                                <button class="btn btn-primary" type="submit" id="iosAuditBtnSave">保存内容</button>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <jsp:include page="/common/foot-form-js.jsp" flush="true"></jsp:include>
	...
	<script>
		$(document).ready(function() {
            ...
            $("#iosAuditBtnSave").click(function(){
                $("#iosAuditForm").submitForm(function(result){
                    if("1" == result){
                        $("#paramsiosAudit").attr("value","");
                        Public.message("设置成功");
                    }else{
                        Public.message("设置失败");
                    }
