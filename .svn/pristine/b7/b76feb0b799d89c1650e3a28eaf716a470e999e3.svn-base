...
public class DataHelper {
    ...
    public final static String sign_key = "328543AA179A4A588311C2C7";
    ...
    // 锟斤拷值锟斤拷锟斤拷转锟斤拷 锟斤拷锟斤拷锟截憋拷锟斤拷锟斤拷址锟�转锟斤拷为锟姐付锟斤拷锟侥憋拷锟斤拷
