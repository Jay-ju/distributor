...
<head>
    ...
    <title>银行卡绑定</title>
    <meta name="keywords" content="银行卡绑定">
    <meta name="description" content="银行卡绑定">
...
<div class="max-box">
    <div class="top tc">
		<a href="javascript:wxcommon.goback('${ctx }');" target="_self" class="black">银行卡绑定</a>
	</div>
    <form id=""  method="post">
        	<input type="hidden" id="userId" name="userId" value="${userId}">
    	<input type="hidden" id="type" name="type" value="2">
        <div class="phone_box plr mt5">
        	<input type="text" name="accountName" id="accountName" value="" placeholder="请输入银行卡姓名" class="telnum" style="width:100%"/>
        </div>
        <div class="phone_box plr" >
        	<input type="text" name="accountBank" id="accountBank" value="" placeholder="请输入开户行" class="telnum" style="width:100%"/>
        </div> 
        <div class="phone_box plr" style="border:0px;">
        	<input type="text" name="accountCode" id="accountCode" value="" placeholder="请输入银行卡卡号" class="telnum" style="width:100%"/>
        </div>
        <div class="new-built2 built back-none">
          <!--   <button type="submit" value="确认" class="text-f plus bg_5">确认</button>-->
