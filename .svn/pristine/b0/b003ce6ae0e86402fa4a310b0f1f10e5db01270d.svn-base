...
import com.zx.stlife.service.member.StatMarginService;
...
public class MemberController extends BaseController {
	...
	@Autowired
	private StatMarginService statMarginService;
	...
	public String preset(Model model, Page page, ParamsEntity paramsEntity){
		presetContent(model, page, paramsEntity);
		return VIEW_URI_PREFIX + "preset";
	}
	
	@RequiresPermissions(PERMISSION_PREFIX + PERMISSION_VIEW)
	@RequestMapping(value = "margin")
	public String margin(Model model, Page page, ParamsEntity paramsEntity){
		marginContent(model, page, paramsEntity);
		return VIEW_URI_PREFIX + "margin";
	}
	...
	@RequiresPermissions(PERMISSION_PREFIX + PERMISSION_VIEW)
	@RequestMapping(value = "preset-content")
	public String presetContent(Model model, Page page, ParamsEntity paramsEntity) {
		goodsTimesService.getpreset(page, paramsEntity.getParams(), false);
		model.addAttribute("page", page);
		bindModel(model);
		return VIEW_URI_PREFIX + "preset-content";
	}
	
	@RequiresPermissions(PERMISSION_PREFIX + PERMISSION_VIEW)
	@RequestMapping(value = "margin-content")
	public String marginContent(Model model, Page page, ParamsEntity paramsEntity) {
		statMarginService.getMargin(page, paramsEntity.getParams());
		model.addAttribute("page", page);
		bindModel(model);
		return VIEW_URI_PREFIX + "margin-content";
	}
	...
	public void bindModel(Model model){
		...
		model.addAttribute("virtualMap",Const.UserVirtual.virtualMap);
