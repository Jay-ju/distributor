...
public class Const {
     ...
     * 是否虚拟用户
     */
    public static class UserVirtual{
    	/**是*/
    	public static final Byte ENABLE = 1;
    	...
    	public static Map<Byte, String> virtualMap = new LinkedHashMap<>(2);
    	static {
    		virtualMap.put(ENABLE, "是");
    		virtualMap.put(DISENABLED, "否");
        }
    }
    ...
    public static class PayWayType {
        ...
        /**汇付宝*/
        public static final Byte HEEPAY = 5;
        /**微信APP*/
        public static final Byte WEIXINAPP = 6;
        /**环迅支付*/
        public static final Byte IPSPAY = 7;
        ...
        static {
        	...
        	payWayMap.put(HEEPAY, "汇付宝");
        	payWayMap.put(WEIXINAPP, "APP微信支付");
        	payWayMap.put(IPSPAY, "环迅支付");
        }
    }
    ...
    /**微信APP下单url*/
    public static String WXAPPPAY_ORDER_URL = appPropertiesLoader.getProperty("wxapp.pay.order.url");
    /**微信APP商品号*/
    public static String WXAPPPAY_MCH_ID = appPropertiesLoader.getProperty("wxapp.pay.mch.id");
    /**微信APP商品密钥*/
    public static String WXAPPPAY_SECRET = appPropertiesLoader.getProperty("wxapp.pay.secret.key");
    /**微信APP支付回调url*/
    public static String WXAPPPAY_NOTIFY_URL = appPropertiesLoader.getProperty("wxapp.pay.notify.url");
    /**微信APP充值回调url*/
    public static String WXAPPPAY_RECHARGE_URL = appPropertiesLoader.getProperty("wxapp.recharge.notify.url");
    
    /**汇付宝下单url*/
    public static String HEEPAY_ORDER_URL = appPropertiesLoader.getProperty("hee.pay.order.url");
    /**汇付宝商品号*/
    public static String HEEPAY_AGENT_ID = appPropertiesLoader.getProperty("hee.pay.agent.id");
    /**汇付宝商品密钥*/
    public static String HEEPAY_AGENT_KEY = appPropertiesLoader.getProperty("hee.pay.agent.key");
    /**汇付宝支付回调url*/
    public static String HEEPAY_NOTIFY_URL = appPropertiesLoader.getProperty("hee.pay.notify.url");
    /**汇付宝支付查询url*/
    public static String HEEPAY_QUERY_URL = appPropertiesLoader.getProperty("hee.pay.query.url");
    
    /**环迅支付下单url*/
    public static String IPSPAY_ORDER_URL = appPropertiesLoader.getProperty("ips.pay.order.url");
    /**环迅支付商品号*/
    public static String IPSPAY_MER_CODE = appPropertiesLoader.getProperty("ips.pay.mer.code");
    /**环迅支付账户号*/
    public static String IPSPAY_ACCOUNT = appPropertiesLoader.getProperty("ips.pay.account");
    /**环迅支付商品密钥*/
    public static String IPSPAY_SECRET = appPropertiesLoader.getProperty("ips.pay.secret.key");
    /**环迅支付回调url*/
    public static String IPSPAY_NOTIFY_URL = appPropertiesLoader.getProperty("ips.pay.notify.url");
    /**环迅支付充值回调url*/
    public static String IPSPAY_RECHARGE_URL = appPropertiesLoader.getProperty("ips.recharge.notify.url");
    /**环迅支付支付方式*/
    public static String IPSPAY_GATEWAYTYPE = appPropertiesLoader.getProperty("ips.pay.gatewaytype");
    /**环迅支付结果成功返回的商户URL*/
    public static String IPSPAY_MERCHANT_URL = appPropertiesLoader.getProperty("ips.pay.merchanturl");
    /**环迅支付结果失败返回的商户URL*/
    public static String IPSPAY_FAIL_URL = appPropertiesLoader.getProperty("ips.pay.failurl");
    /**环迅支付商品名字*/
    public static String IPSPAY_GOODS_NAME = appPropertiesLoader.getProperty("ips.pay.goods.name");
}
